...
namespace GridExtensions
{
	public static class GridExtensions
	{
		...
		public static void AddMaxHeightRows(this Grid pGrid, int numberOfRowsToAdd)
		{
			for (int x = 0; x < numberOfRowsToAdd; x++)
			{
				pGrid.AddMaxHeightRow();
			}
		}

		public static void AddAutoHeightRows(this Grid pGrid, int numberOfRowsToAdd)
		{
			for (int x = 0; x < numberOfRowsToAdd; x++)
			{
				pGrid.AddAutoHeightRow();
			}
		}
